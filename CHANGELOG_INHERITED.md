# Inherited Changelog (anusii/solid_auth ≤ 0.1.27)

This history was inherited from the original [`solid_auth`](https://github.com/anusii/solid_auth) package
by the Australian National University Intelligent Systems Institute (anusii).
`solid_oidc_auth` is a ground-up rewrite that retains only the DPoP token
generation logic and the example app structure from that codebase.
